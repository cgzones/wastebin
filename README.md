...
| `WASTEBIN_RATELIMIT_INSERT`       | Maximum allowed creation amount of new pastes per second.     | `0` (disabled)        |
| `WASTEBIN_RATELIMIT_DELETE`       | Maximum allowed delete attempts of existing pastes per second. | `0` (disabled)       |
