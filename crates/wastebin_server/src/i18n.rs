...
static EN: phf::Map<&'static str, &'static str> = phf_map! {
    ...
    "paste.help.close_help" => "Close this help",
    ...
    "error.empty_paste" => "A paste needs some content.",
    ...
    "error.malformed_request" => "The request could not be processed.",
    "error.qr_too_long" => "This address is too long to put into a QR code.",
    "error.burn_not_confirmed" => "This paste is destroyed when read. Open it on its own page to confirm.",
...
static DE: phf::Map<&'static str, &'static str> = phf_map! {
    ...
    "paste.help.view_raw" => "Rohansicht anzeigen",
    ...
    "paste.help.close_help" => "Diese Hilfe schließen",
    ...
    "error.empty_paste" => "Ein Paste braucht einen Inhalt.",
    ...
    "error.malformed_request" => "Die Anfrage konnte nicht verarbeitet werden.",
    "error.qr_too_long" => "Diese Adresse ist zu lang für einen QR-Code.",
    "error.burn_not_confirmed" => "Dieser Eintrag wird beim Lesen gelöscht. Zum Bestätigen die zugehörige Seite öffnen.",
...
static ZH: phf::Map<&'static str, &'static str> = phf_map! {
    ...
    "error.empty_paste" => "剪贴需要有内容。",
    "error.rate_limit" => "请求过于频繁，请稍后再试。",
    "error.too_long_expires" => "请求的有效期超出本服务器允许的范围。",
    "error.malformed_form" => "无法处理提交的表单。",
    "error.malformed_request" => "无法处理该请求。",
    "error.qr_too_long" => "此地址太长，无法生成二维码。",
    "error.burn_not_confirmed" => "此粘贴内容将在阅读后销毁。请在其页面上确认。",
